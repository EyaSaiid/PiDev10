...
return [
    ...
    'livraisonback' => [[], ['_controller' => 'App\\Controller\\LivraisonbackController::index'], [], [['text', '/livraisonback']], [], []],
    'Affichel' => [[], ['_controller' => 'App\\Controller\\LivraisonbackController::AfficheAF'], [], [['text', '/Affichel']], [], []],
    'Update' => [['id'], ['_controller' => 'App\\Controller\\LivraisonbackController::Update'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/UpdateA']], [], []],
    'delete' => [['id'], ['_controller' => 'App\\Controller\\LivraisonbackController::delete'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/sup']], [], []],
