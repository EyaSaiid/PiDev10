...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('XWHbHzL0fZ', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('y+cnR-olcy', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qP5Jf3BS1K', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gDw+fd8tqG', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pjvTDyxOWu', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('iCBiA9ZQZ6', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CYx4bI+dzT', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder97399 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer572ab = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesa5312 = [
        
    ];

    public function getConnection()
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'getConnection', array(), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'getMetadataFactory', array(), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'getExpressionBuilder', array(), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'beginTransaction', array(), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'getCache', array(), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->getCache();
    }

    public function transactional($func)
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'transactional', array('func' => $func), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'wrapInTransaction', array('func' => $func), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'commit', array(), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->commit();
    }

    public function rollback()
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'rollback', array(), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'getClassMetadata', array('className' => $className), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'createQuery', array('dql' => $dql), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'createNamedQuery', array('name' => $name), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'createQueryBuilder', array(), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'flush', array('entity' => $entity), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'clear', array('entityName' => $entityName), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->clear($entityName);
    }

    public function close()
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'close', array(), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->close();
    }

    public function persist($entity)
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'persist', array('entity' => $entity), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'remove', array('entity' => $entity), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'refresh', array('entity' => $entity), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'detach', array('entity' => $entity), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'merge', array('entity' => $entity), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'getRepository', array('entityName' => $entityName), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'contains', array('entity' => $entity), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'getEventManager', array(), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'getConfiguration', array(), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'isOpen', array(), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'getUnitOfWork', array(), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'getProxyFactory', array(), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'initializeObject', array('obj' => $obj), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'getFilters', array(), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'isFiltersStateClean', array(), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'hasFilters', array(), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return $this->valueHolder97399->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer572ab = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder97399) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder97399 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder97399->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, '__get', ['name' => $name], $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        if (isset(self::$publicPropertiesa5312[$name])) {
            return $this->valueHolder97399->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder97399;
    ...
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;
    ...
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, '__isset', array('name' => $name), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;
    ...
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, '__unset', array('name' => $name), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;
    ...
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, '__clone', array(), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        $this->valueHolder97399 = clone $this->valueHolder97399;
    }

    public function __sleep()
    {
        $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, '__sleep', array(), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;

        return array('valueHolder97399');
    }
    ...
    {
        $this->initializer572ab = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer572ab;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer572ab && ($this->initializer572ab->__invoke($valueHolder97399, $this, 'initializeProxy', array(), $this->initializer572ab) || 1) && $this->valueHolder97399 = $valueHolder97399;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder97399;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder97399;
    }
}
