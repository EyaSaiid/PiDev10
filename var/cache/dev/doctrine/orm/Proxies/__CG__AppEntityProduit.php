...
class Produit extends \App\Entity\Produit implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'nomProduit', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'descriptionProduit', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'prixProduit', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'quantiteProduit', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'commandes'];
        }
     ...
     * {@inheritDoc}
     */
    public function setDescriptionProduit(string $descriptionProduit): \App\Entity\Produit
    {
