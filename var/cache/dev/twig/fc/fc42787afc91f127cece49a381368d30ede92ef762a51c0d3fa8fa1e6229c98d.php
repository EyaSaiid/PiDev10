...
class __TwigTemplate_d6c1045b1898e5c0216cc502ca8e0fab6bd47d7d66b20fd91d7de80ca39cbfad extends Template
{
    private $source;
    private $macros = [];
...
<p>nom: ";
        // line 2
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["contact"]) || array_key_exists("contact", $context) ? $context["contact"] : (function () { throw new RuntimeError('Variable "contact" does not exist.', 2, $this->source); })()), "name", [], "any", false, false, false, 2), "html", null, true);
        echo "</p>
<p>email: ";
        // line 3
