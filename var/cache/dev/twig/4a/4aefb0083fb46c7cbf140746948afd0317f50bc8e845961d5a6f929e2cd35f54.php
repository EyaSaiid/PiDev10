...
class __TwigTemplate_492d8f12b71625cdf37698c9e8228ba2266dddddb348fe855b783d928ce6ee07 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("base2.html.twig", "categorie/_form.html.twig", 1);
    ...
    ";
        ...
        <div class=\"alert-danger\" style=\"align-content: center\">
            ";
        // line 8
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 8, $this->source); })()), "Libelle", [], "any", false, false, false, 8), 'errors');
        echo "
        </div>
        ";
        // line 10
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 10, $this->source); })()), "Libelle", [], "any", false, false, false, 10), 'label', ["label" => "libelle du produit"]);
        echo "
        ";
        // line 11
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 11, $this->source); })()), "Libelle", [], "any", false, false, false, 11), 'widget', ["attr" => ["class" => "form-control", "placeholder" => "ajouter le libelle"]]);
        echo "
    </div>
...
";
    ...
    {
        return array (  97 => 15,  93 => 14,  87 => 11,  83 => 10,  78 => 8,  73 => 5,  68 => 3,  58 => 2,  35 => 1,);
    }
...
{% block body %}
    ...
    <div class=\"form-group\">
        ...
        {{ form_label(form.Libelle,\"libelle du produit\") }}
        {{ form_widget(form.Libelle ,{'attr': {'class': 'form-control','placeholder':'ajouter le libelle'}}) }}
    </div>
...
{% endblock %}
", "categorie/_form.html.twig", "C:\\Users\\Nour Hammami\\Desktop\\pii\\PiDev10\\templates\\categorie\\_form.html.twig");
    }
}
