...
class __TwigTemplate_c2e40e7a3f1beaf4506fc0428a12b258ef8a607c6ee426395c282027a5952a73 extends Template
{
    private $source;
    private $macros = [];
   ...
   ";
    ...
    <div class=\"control-group\">
        ";
        // line 17
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 17, $this->source); })()), "nombre", [], "any", false, false, false, 17), 'label', ["label" => "nombre de place à reserver"]);
        echo "
        ";
        // line 18
