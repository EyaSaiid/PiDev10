...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.qwvQn69' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_QwvQn69Service()
    {
        return $this->privates['.service_locator.qwvQn69'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Controller\\ReservationController::edit' => ['privates', '.service_locator.seS9gks', 'get_ServiceLocator_SeS9gksService', false],
            'App\\Controller\\ReservationController::index' => ['privates', '.service_locator.COMnccu', 'get_ServiceLocator_COMnccuService', false],
            'App\\Controller\\ReservationController::new' => ['privates', '.service_locator.XISRjPO', 'get_ServiceLocator_XISRjPOService', false],
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.qwvQn69'] ?? $this->get_ServiceLocator_QwvQn69Service())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder72eb1 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer31cf0 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties0d851 = [
        
    ];

    public function getConnection()
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'getConnection', array(), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'getMetadataFactory', array(), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'getExpressionBuilder', array(), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'beginTransaction', array(), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'getCache', array(), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->getCache();
    }

    public function transactional($func)
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'transactional', array('func' => $func), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'wrapInTransaction', array('func' => $func), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'commit', array(), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->commit();
    }

    public function rollback()
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'rollback', array(), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'getClassMetadata', array('className' => $className), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'createQuery', array('dql' => $dql), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'createNamedQuery', array('name' => $name), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'createQueryBuilder', array(), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'flush', array('entity' => $entity), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'clear', array('entityName' => $entityName), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->clear($entityName);
    }

    public function close()
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'close', array(), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->close();
    }

    public function persist($entity)
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'persist', array('entity' => $entity), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'remove', array('entity' => $entity), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'refresh', array('entity' => $entity), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'detach', array('entity' => $entity), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'merge', array('entity' => $entity), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'getRepository', array('entityName' => $entityName), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'contains', array('entity' => $entity), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'getEventManager', array(), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'getConfiguration', array(), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'isOpen', array(), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'getUnitOfWork', array(), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'getProxyFactory', array(), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'initializeObject', array('obj' => $obj), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'getFilters', array(), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'isFiltersStateClean', array(), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'hasFilters', array(), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return $this->valueHolder72eb1->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer31cf0 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder72eb1) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder72eb1 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder72eb1->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, '__get', ['name' => $name], $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        if (isset(self::$publicProperties0d851[$name])) {
            return $this->valueHolder72eb1->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder72eb1;
    ...
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;
    ...
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, '__isset', array('name' => $name), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;
    ...
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, '__unset', array('name' => $name), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;
    ...
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, '__clone', array(), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        $this->valueHolder72eb1 = clone $this->valueHolder72eb1;
    }

    public function __sleep()
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, '__sleep', array(), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        return array('valueHolder72eb1');
    }
    ...
    {
        $this->initializer31cf0 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer31cf0;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'initializeProxy', array(), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder72eb1;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder72eb1;
    }
}
...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializer31cf0 && ($this->initializer31cf0->__invoke($valueHolder72eb1, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer31cf0) || 1) && $this->valueHolder72eb1 = $valueHolder72eb1;

        if ($this->valueHolder72eb1 === $returnValue = $this->valueHolder72eb1->paginate($target, $page, $limit, $options)) {
            return $this;
        }
