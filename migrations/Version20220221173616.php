 ...
 */
final class Version20220221173616 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD address VARCHAR(255) DEFAULT NULL, CHANGE image image VARCHAR(255) NOT NULL');
    }
