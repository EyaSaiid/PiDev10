 ...
 */
final class Version20220212224511 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit_plat MODIFY id INT NOT NULL');
        $this->addSql('ALTER TABLE produit_plat DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE produit_plat CHANGE id id_produitplat INT AUTO_INCREMENT NOT NULL');
        $this->addSql('ALTER TABLE produit_plat ADD PRIMARY KEY (id_produitplat)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit_plat DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE produit_plat CHANGE nom_produitplat nom_produitplat VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE id_produitplat id INT AUTO_INCREMENT NOT NULL');
        $this->addSql('ALTER TABLE produit_plat ADD PRIMARY KEY (id)');
